      ...
      <BrowserRouter basename={"/"}>
        <ScrollContext>
          <Switch>
            <Route
              exact
              path={`${process.env.PUBLIC_URL}${ROUTES.LOGIN}`}
              component={Login}
            />
            ...
            <App>
              ...
              <Route
                path={`${process.env.PUBLIC_URL}${ROUTES.LIST_PAGES}`}
                component={ListPages}
              />
              <Route
                path={`${process.env.PUBLIC_URL}${ROUTES.CREATE_PAGE}`}
              ...
              <Route
                path={`${process.env.PUBLIC_URL}${ROUTES.LIST_MENUS}`}
                component={List_menu}
              />
              <Route
                path={`${process.env.PUBLIC_URL}${ROUTES.CREATE_MENU}`}
                component={Create_menu}
              />

              <Route
                path={`${process.env.PUBLIC_URL}${ROUTES.LIST_USERS}`}
                component={List_user}
              />
              <Route
                path={`${process.env.PUBLIC_URL}${ROUTES.CREATE_USER}`}
